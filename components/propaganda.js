    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="lg:text-center">
        ...
        <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
          Some say{' '}
          <a
            href="https://www.theamericanconservative.com/articles/you-cant-just-build-your-own-twitter/"
            target="_blank"
            className="text-indigo-500 italic font-bold"
          >
            "you can't just build your own Twitter"
          </a>{' '}
          because you'd need to build your own internet! Well,{' '}
